...
(function ($) {
    ...
    function SlickGrid(container, data, columnDefinitions, options) {
        ...
        /* @const */
        var tabbingDirections = LU(NAVIGATE_UP, -1,
            NAVIGATE_DOWN, 1,
            NAVIGATE_LEFT, -1,
            NAVIGATE_RIGHT, 1,
            NAVIGATE_PREV, -1,
        ...
        function createColumnHeaders() {
            ...
            if (hasNestedColumns) {
                    ...
                    for (var j = 0, llen = layer.length; j < llen; j++) {
                       var column = layer[j];
                        if (column.children) {
 ...
 function getCellFromPoint(x, y)
  ...
  function setActiveCellInternal(newCell, opt_editMode)
        ...
        function makeActiveCellEditable(editor) {
            ...
            var columnMetadata = rowMetadata &&
                rowMetadata.columns &&
                (rowMetadata.columns[columnDef.id] || rowMetadata.columns[activeCell]);
            ...
            if (!activeCellNode && dir !== NAVIGATE_PREV && dir !== NAVIGATE_NEXT && dir !== NAVIGATE_HOME && dir !== NAVIGATE_END) {
                if (0) {
                    ...
                    if (focusedNode) {
                        ...
                        var visible = getVisibleRange();
                        assert(visible);
                        //noinspection JSSuspiciousNameCombination,JSUnusedLocalSymbols,JSSuspiciousNameCombination,JSSuspiciousNameCombination
                        var left = getCellFromPoint(visible.topPx, visible.leftPx);
                        //noinspection JSUnusedLocalSymbols,JSSuspiciousNameCombination,JSSuspiciousNameCombination
