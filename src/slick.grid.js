...
(function( $ )
{
  ...
  function SlickGrid( container, data, columns, options )
  {
      ...
      for ( var i = 0; i < columns.length; i++ )
      {
        ...
        var header = $( "<div class='ui-state-default slick-header-column' />" )
           ...
           // .width( m.width - headerColumnWidthDiff )
            ...
            //
            .outerWidth(columns[i].width- headerColumnWidthDiff)
            .attr( "id", "" + uid + m.id )
    ...
    function createCssRules()
    {
      ...
      var rules = ["." + uid + " .slick-header-column { left: 1000px; }", "." + uid + " .slick-top-panel { height:" + options.topPanelHeight + "px; }",
        "." + uid + " .slick-headerrow-columns { height:" + options.headerRowHeight + "px; }", "." + uid + " .slick-cell { height:" + rowHeight + "px; }",
    ...
    function setSortColumns( cols )
    {
      ...
      headerColumnEls.removeClass( "slick-header-column-sorted" ).find( ".slick-sort-indicator" )
    ...
    {
      var rowMetadata = data.getItemMetadata && data.getItemMetadata( row, column );
    ...
    function getViewportHeight()
    {
      ...
      } else
      {
        ...
        viewportH = parseFloat( $.css( $container[0], "height", true ) ) - parseFloat( $.css( $container[0], "paddingTop", true ) ) - parseFloat(
                $.css( $container[0], "paddingBottom", true ) ) - parseFloat( $.css( $headerScroller[0], "height" ) ) - getVBoxDelta(
                $headerScroller ) - topPanelH - headerRowH;
      }
