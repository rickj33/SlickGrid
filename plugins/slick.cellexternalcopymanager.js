            ...
            var clipCommand = {
                ...
                execute : function() {
                                ...
                                if (destRow < this.maxDestRows && destColumn < this.maxDestColumns) {
                                    ...
                                    if (oneCellToMultiple) {
                                        ...
                                        if (_options.includeHeaderWhenCopying) {
                                            ...
                                            this.setDataItemValueForColumn(dataRow, columns[destColumn], clippedRange[row] ? clippedRange[row][column] : '');
                                        }
                                    }
                    ...
                    var bRange = {
                        ...
                        'toRow'        : activeRow + clippedRows - 1, /*   'toCell'  : activeCell + this.maxDestColumns - 1,
